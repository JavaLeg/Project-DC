...
public class State {
	...
	public Enemy getEnemy(int[] coord){
		return this.map[coord[0]][coord[1]].getEnemy();
	}
	...
	public boolean deleteEnemy(int[] coord){
		return this.map[coord[0]][coord[1]].deleteEnemy();
	}
	...
	public Trap getTrap(int[] coord){
		return this.map[coord[0]][coord[1]].getTrap();
	}
	...
	public boolean deleteTrap(int[] coord){
		return this.map[coord[0]][coord[1]].deleteTrap();
	}
	...
	public Item getItem(int[] coord){
		return this.map[coord[0]][coord[1]].getItem();
	}
	...
	public boolean deleteItem(int[] coord){
		return this.map[coord[0]][coord[1]].deleteItem();
	}
	...
	public Terrain getTerrain(int[] coord){
		return this.map[coord[0]][coord[1]].getTerrain();
	}
